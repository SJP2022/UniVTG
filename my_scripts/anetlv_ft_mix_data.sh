#!/bin/bash
#SBATCH -o out/anetlv_ft_out/anetlv_ft_mix_data.out
#SBATCH --partition=fvl       # 作业提交的指定分区;
#SBATCH --qos=high            # 指定作业的QOS;
#SBATCH -J anetlv_ft_mix_data # 作业在调度系统中的作业名;
...
mix_path=data/anetlv_new/metadata/train.jsonl
feat_root_mix=data/anetlv_new
...
--out ${out} \
--eval_init ${@:1}  \
> out/anetlv_ft_out/anetlv_ft_mix_data.out
...
dset_name=anet
anno_type=anetlv
out=anetlv_ft_mix_data_inference
clip_length=2
...
resume=results/mr-anetlv/qvhl-anetlv_ft_mix_data/model_best.ckpt
...
--out ${out} \
--eval_init ${@:1}  \
> out/anetlv_ft_out/anetlv_ft_mix_data_inference.out