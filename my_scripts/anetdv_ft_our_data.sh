#!/bin/bash
#SBATCH -o out/anetdv_ft_out/anetdv_ft_our_data.out
#SBATCH --partition=fvl       # 作业提交的指定分区;
#SBATCH --qos=high            # 指定作业的QOS;
#SBATCH -J anetdv_ft_our_data # 作业在调度系统中的作业名;
...
eval_path=data/anetdv_new/metadata/val.jsonl
eval_split_name=val
feat_root=data/anetdv_new
feat_root_val=data/anetdv_new
...
--out ${out} \
--eval_init ${@:1}  \
> out/anetdv_ft_out/anetdv_ft_our_data.out
...
dset_name=anet
anno_type=anetdv
out=anetdv_ft_our_data_inference
clip_length=2
...
resume=results/mr-anetdv/qvhl-anetdv_ft_our_data/model_best.ckpt
...
--out ${out} \
--eval_init ${@:1}  \
> out/anetdv_ft_out/anetdv_ft_our_data_inference.out