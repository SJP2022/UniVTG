#!/bin/bash
#SBATCH -o out/anetlv_ft_out/anetlv_ft_raw_data.out
#SBATCH --partition=fvl       # 作业提交的指定分区;
#SBATCH --qos=high            # 指定作业的QOS;
#SBATCH -J anetlv_ft_raw_data # 作业在调度系统中的作业名;
...
--out ${out} \
--eval_init ${@:1}  \
> out/anetlv_ft_out/anetlv_ft_raw_data.out
...
dset_name=anet
anno_type=anetlv
out=anetlv_ft_raw_data_inference
clip_length=2
...
resume=results/mr-anetlv/qvhl-anetlv_ft_raw_data/model_best.ckpt
...
--out ${out} \
--eval_init ${@:1}  \
> out/anetlv_ft_out/anetlv_ft_raw_data_inference.out